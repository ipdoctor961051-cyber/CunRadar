/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 584413512285f95d09b692c8b01b5581)
// Runtime types generated with workerd@1.20260801.1 2026-08-11 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	GITHUB_OWNER: "ipdoctor961051-cyber";
	GITHUB_REPO: "CunRadar";
	REPORT_URL: "https://cunradar-cyl.pages.dev";
	ADMIN_PASSWORD: string;
	CONFIG_READ_TOKEN: string;
	GITHUB_TOKEN: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GITHUB_OWNER" | "GITHUB_REPO" | "REPORT_URL" | "ADMIN_PASSWORD" | "CONFIG_READ_TOKEN" | "GITHUB_TOKEN">> {}
}
